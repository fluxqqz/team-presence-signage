...
const statusRing: Record<PresenceStatus, string> = {
  hadir: 'ring-[3px] ring-[#FFF9FF] shadow-[0_0_0_1px_#a8a29e]',
  sakit: 'ring-[3px] ring-[#FF080B] shadow-[0_0_0_1px_rgba(0,0,0,0.18)]',
  izin_terlambat: 'ring-[3px] ring-[#FFFB01] shadow-[0_0_0_1px_rgba(0,0,0,0.18)]',
  cuti: 'ring-[3px] ring-[#F243FF] shadow-[0_0_0_1px_rgba(0,0,0,0.18)]',
  lapangan: 'ring-[3px] ring-[#0CF2FF] shadow-[0_0_0_1px_rgba(0,0,0,0.18)]',
  wfh: 'ring-[3px] ring-[#0EFF12] shadow-[0_0_0_1px_rgba(0,0,0,0.18)]',
  off: 'ring-[3px] ring-stone-400 shadow-[0_0_0_1px_rgba(0,0,0,0.18)]',
};
