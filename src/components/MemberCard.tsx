...
const statusRing: Record<PresenceStatus, string> = {
  hadir: 'ring-stone-400 ring-offset-2 ring-offset-[#fbfaf7]',
  sakit: 'ring-[#FF080B] ring-offset-2 ring-offset-[#fbfaf7]',
  izin_terlambat: 'ring-[#FFFB01] ring-offset-2 ring-offset-[#fbfaf7]',
  cuti: 'ring-[#F243FF] ring-offset-2 ring-offset-[#fbfaf7]',
  lapangan: 'ring-[#0CF2FF] ring-offset-2 ring-offset-[#fbfaf7]',
  wfh: 'ring-[#0EFF12] ring-offset-2 ring-offset-[#fbfaf7]',
  off: 'ring-stone-400 ring-offset-2 ring-offset-[#fbfaf7]',
};
